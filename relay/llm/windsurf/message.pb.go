...
type ChatMessage struct {
	...
	UnknownField9  []*ChatMessage_Unknown_Field9 `protobuf:"bytes,9,rep,name=unknown_field9,json=unknownField9,proto3" json:"unknown_field9,omitempty"` // deepseek需要
...
var file_windsurf_message_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_windsurf_message_proto_goTypes = []interface{}{
	...
	(*Jwt_Args)(nil),                               // 18: windsurf.Jwt.Args
}
var file_windsurf_message_proto_depIdxs = []int32{
	...
	18, // 10: windsurf.Jwt.args:type_name -> windsurf.Jwt.Args
